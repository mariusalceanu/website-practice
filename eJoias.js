...
function scrollFunction() {
  if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
    document.getElementById('nav-scroll').style.height = "100px";
    document.getElementById('logo-scroll').style.fontSize = '30px';
    
    document.getElementById('go-to-top').style.display = 'block';
    
  } else {
    document.getElementById('nav-scroll').style.height = '170px';
    document.getElementById('logo-scroll').style.fontSize = '50px';
